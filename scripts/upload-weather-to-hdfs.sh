...
hdfs dfs -mkdir -p /weathertextdb
hdfs dfs -put -f '$abs_body' /weathertextdb/weather_observations.csv
hdfs dfs -ls /weathertextdb
hdfs dfs -cat /weathertextdb/weather_observations.csv 2>/dev/null | sed -n '1,5p' || true
"
